...
export default function GsapBackground() {
  ...
  useEffect(() => {
    // We use gsap.context in React to easily clean up the animations when the component unmounts
    ...
    return () => ctx.revert(); // Cleanup to prevent duplicate animations
  }, []);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <stop offset="0%" stopColor="#FBBC04" />   {/* Gemini Yellow */}
        <stop offset="33%" stopColor="#4285F4" />  {/* Gemini Blue */}
        <stop offset="66%" stopColor="#EA4335" /> {/* Fades to Black/Void */}
        <stop offset="100%" stopColor="#10b28a" />  {/* ChatGPT Green */}
        </linearGradient>
